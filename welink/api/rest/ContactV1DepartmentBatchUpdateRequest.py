...
"""
批量更新部门
https://open.welink.huaweicloud.com/docs/#/990hh0/whokyc/k52uh1
...
class ContactV1DepartmentBatchUpdateRequest(RestApi):
    """批量更新部门"""
    ...
    def get_valid_path(self):
        return ("/api/contact/v1/department/batch/update",)
