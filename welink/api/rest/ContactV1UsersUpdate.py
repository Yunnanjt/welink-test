...
class ContactV1UsersUpdateRequest(RestApi):
    """异步批量同步用户"""

    def __init__(self, url):
        super(ContactV1UsersUpdateRequest, self).__init__(url)
        self.__body_params = super(
            ContactV1UsersUpdateRequest, self
        ).get_body_params()
        ...
        self.__valid_path = ("/api/contact/v1/users/update",)
